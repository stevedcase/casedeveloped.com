	...
	<motion.div variants={fadeIn("", "spring", index * 0.5, 0.75)} className="testcard bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full">
		...
		<div className="mt-1">
			...
			<div className="mt-7 flex justify-between items-center gap-1">
				<div className="testimonial-info flex-1 flex flex-col">
					{/* 
					...
					*/}
					...
					<p className={`${styles.testimonialsDesignation}`}>{designation}</p>
					<p className={`${styles.testimonialsCompany}`}>{company}</p>
				</div>
		...
		<div className={`mt-12 bg-black-100 rounded-[20px]`}>
			<div className={`bg-tertiary rounded-2xl ${styles.padding} min-h-[300px]`}>
				<motion.div variants={textVariant()}>
					<p className={styles.sectionSubText}>Colleague Comments</p>
