...
const Hero = () => {
	return (
		<section className="relative w-full h-screen mx-auto">
			...
			<div className={`${styles.paddingX} absolute inset-0 top-[75px] max-w-7x1 mx-auto flex flex-row items-start gap-5`}>
			...
			<div className="absolute xs:bottom-45 bottom-10 w-full flex justify-center items-center">
				<a href="#about">
